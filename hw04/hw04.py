...
def balanced(m):
    ...
    return left_balanced and right_balanced and length(left_arm) * total_mass(end(left_arm)) == length(right_arm) * total_mass(end(right_arm))
